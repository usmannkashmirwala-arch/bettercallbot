const industries = [
  ...
  { name: 'TECHNOLOGY BRANDS', desc: 'Specs, warranties, setup help.' },
  { name: 'CUTLERY STORES', desc: 'Sets, care, engraving orders.' },
  { name: 'BAGS & WALLETS STORES', desc: 'Materials, sizing, restocks.' },
];

export default function Industries() {
  return (
    <section id="industries" className="px-6 md:px-12 py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 border-t border-l border-[#CCCCCC]">
        {industries.map((ind) => (
          <div
            key={ind.name}
            className="p-6 md:p-8 border-[#CCCCCC] border-r border-b group cursor-pointer hover:bg-[#111111] transition-colors duration-200"
          >
